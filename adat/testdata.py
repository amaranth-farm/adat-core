...
def encode_nrzi(input: list, initial_bit: int = 1) -> list:
    result = [initial_bit]
    for bit in input:
        last_bit = result[-1]
...
if __name__ == "__main__":
    print(list(generate_sixteen_frames_with_channel_numbers_in_most_significant_nibble_and_sample_numbers_in_sample()))
